      ...
      <div className="mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-4 max-h-[65px] overflow-hidden">
          ...
          <nav className="hidden items-center gap-1 md:flex">
            <Link
              href="/dashboard"
              className="rounded-md px-3 py-2 text-sm font-medium text-foreground transition-colors hover:bg-muted/50 flex items-center gap-1"
            >
          ...
          <div className="relative w-full max-w-xl group">
            ...
            >
              ...
              <input
                ...
                className="h-13 w-full rounded-2xl border-2 border-[#F2B33D]/40 bg-background pl-14 pr-4 text-sm font-semibold text-foreground shadow-lg shadow-[#F2B33D]/15 outline-none transition-all placeholder:text-muted-foreground placeholder:font-medium focus:border-[#F2B33D] focus:ring-4 focus:ring-[#F2B33D]/20 focus:shadow-xl focus:shadow-[#F2B33D]/20 focus:bg-card hover:border-[#F2B33D]/60 hover:shadow-xl hover:shadow-[#F2B33D]/15"
              />
              {searchQuery && (
                <button
                  type="button"
                  onClick={() => setSearchQuery("")}
                  className="absolute right-3 top-1/2 -translate-y-1/2 rounded-full p-1.5 text-muted-foreground hover:text-white hover:bg-[#F2B33D] transition-colors"
            ...
            {showSuggestions && searchQuery.trim().length >= 1 && (() => {
              ...
              return (
                <div className="absolute left-0 right-0 top-full mt-2 z-50 rounded-2xl border-2 border-[#F2B33D]/30 bg-popover shadow-2xl overflow-hidden">
                    ...
                    {filtered.map((s) => (
                      <li key={s}>
                        <button
                          ...
                          className="flex w-full items-center gap-2 px-4 py-2 text-left text-sm text-foreground hover:bg-[#F2B33D]/10"
                        >
        ...
        <div className="flex items-center gap-2">
          ...
          {isUserMenuMounted ? (
            ...
            <DropdownMenuContent align="end" className="w-56 bg-popover border-border">
              ...
              <DropdownMenuItem asChild>
                <Link href="/subscribe" className="flex items-center gap-2 text-foreground">
              ...
              {isPremium && (
                <DropdownMenuItem asChild>
                  <Link href="/favorites" className="flex items-center gap-2 text-foreground">
              ...
              {isPremium && (
                <DropdownMenuItem asChild>
                  <Link href="/favorites?tab=collections" className="flex items-center gap-2 text-foreground">
              ...
              <DropdownMenuItem asChild>
                <Link href="/dashboard/brand-requests" className="flex items-center gap-2 text-foreground">
              ...
              {planKeyLower === "pro" && (
                <DropdownMenuItem asChild>
                  <Link href="/decrypte" className="flex items-center gap-2 text-foreground">
      ...
      {isOpen && (
        <div className="border-t border-border bg-background md:hidden">
          ...
          <div className="px-4 py-3">
            <div className="relative">
              ...
              <input
                ...
                className="h-10 w-full rounded-lg border border-border bg-background pl-10 pr-4 text-sm text-foreground outline-none"
              />
            </div>
          </div>
          )}
          <nav className="flex flex-col gap-1 px-4 pb-4">
            ...
            <Link
              href="/dashboard"
              className="rounded-md px-3 py-2 text-sm font-medium text-foreground transition-colors hover:bg-muted/50 flex items-center gap-1.5"
